...
set_property IOSTANDARD LVCMOS33 [get_ports digital_light[0]]
set_property PACKAGE_PIN H2 [get_ports digital_light[0]]
set_property IOSTANDARD LVCMOS33 [get_ports digital_light[1]]
set_property PACKAGE_PIN D2 [get_ports digital_light[1]]
set_property IOSTANDARD LVCMOS33 [get_ports digital_light[2]]
set_property PACKAGE_PIN E2 [get_ports digital_light[2]]
set_property IOSTANDARD LVCMOS33 [get_ports digital_light[3]]
set_property PACKAGE_PIN F3 [get_ports digital_light[3]]
set_property IOSTANDARD LVCMOS33 [get_ports digital_light[4]]
set_property PACKAGE_PIN F4 [get_ports digital_light[4]]
set_property IOSTANDARD LVCMOS33 [get_ports digital_light[5]]
set_property PACKAGE_PIN D3 [get_ports digital_light[5]]
set_property IOSTANDARD LVCMOS33 [get_ports digital_light[6]]
set_property PACKAGE_PIN E3 [get_ports digital_light[6]]
set_property IOSTANDARD LVCMOS33 [get_ports digital_light[7]]
set_property PACKAGE_PIN D4 [get_ports digital_light[7]]

set_property IOSTANDARD LVCMOS33 [get_ports digital_light1[0]]
set_property PACKAGE_PIN D5 [get_ports digital_light1[0]]
set_property IOSTANDARD LVCMOS33 [get_ports digital_light1[1]]
set_property PACKAGE_PIN B2 [get_ports digital_light1[1]]
set_property IOSTANDARD LVCMOS33 [get_ports digital_light1[2]]
set_property PACKAGE_PIN B3 [get_ports digital_light1[2]]
set_property IOSTANDARD LVCMOS33 [get_ports digital_light1[3]]
set_property PACKAGE_PIN A1 [get_ports digital_light1[3]]
set_property IOSTANDARD LVCMOS33 [get_ports digital_light1[4]]
set_property PACKAGE_PIN B1 [get_ports digital_light1[4]]
set_property IOSTANDARD LVCMOS33 [get_ports digital_light1[5]]
set_property PACKAGE_PIN A3 [get_ports digital_light1[5]]
set_property IOSTANDARD LVCMOS33 [get_ports digital_light1[6]]
set_property PACKAGE_PIN A4 [get_ports digital_light1[6]]
set_property IOSTANDARD LVCMOS33 [get_ports digital_light1[7]]
set_property PACKAGE_PIN B4 [get_ports digital_light1[7]]
