...
​		我们的pipeline设计是5级流水线结构，对于Control hazard 和 Structure hazard，我们设定了cpu在时钟上升沿时做写操作，在下降沿时进行读操作，不会产生对同一资源需求的情况。对于Data hazard，我们会通过数据转发的操作来解决这个hazard问题。详情请见Part 9中对pipeline的文档说明。
