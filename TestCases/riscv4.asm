...
# 定义存储数据的内存地址
.data
src_addr: .word 0x4100    # 16 位的半精度浮点数，假设为-2.5: 11000001 00000000 （0000c100） 现在是2.5：01000001 00000000 （00004100）
#-2.125： 11000000 10000000 （0000c080）      2.125：01000000 10000000  （00004080）
...
negative:   
    ...
    # 检查小数部分是否为0
    beqz a6, negative_nodownbound  # 如果a6小数的0.5位是0，那么不动，如果是1的话那么对绝对值加1
    #这里没有通过检测那么需要向下取整
    addi t5, t5, 1
