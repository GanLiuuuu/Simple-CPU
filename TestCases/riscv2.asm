# 将半精度浮点数的十进制向上取整并存储回寄存器a0的程序

# 定义存储数据的内存地址
.data
src_addr: .word 0x4100    # 16 位的半精度浮点数，假设为-2.5: 11000001 00000000 现在是2.5：01000001 00000000
...
negative:
    ...
    # 检查小数部分是否为0
    beqz t6, negative_no_round  # 如果小数部分为0，不用向下取整
    # 小数部分不为0，不需要减1
...
positive:   
    ...
    # 检查小数部分是否为0
    beqz t6, positive_noupperbound  # 如果小数部分为0，不用向上取整
    
    #这里没有通过检测那么需要向上取整
    addi t5, t5, 1
    
    
positive_noupperbound:
    j end	   
